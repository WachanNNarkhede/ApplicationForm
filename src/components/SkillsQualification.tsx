...
const SkillsQualifications = () => {
  ...
  <h2 className="text-3xl font-extrabold heading text-blue-600 mb-10 mt-8">Work Experience</h2>
  <form
  ...
  >
      ...
      <TableBody>
        <TableRow>
          <TableCell className="w-1/2">
            <Label className="text-xl font-medium">Technical Skills</Label>
          </TableCell>
          <TableCell className="w-1/2">
            <Label className="text-xl font-medium">Certifications</Label>
          </TableCell>
        </TableRow>
        <TableRow>
          <TableCell className="w-1/2">
    ...
    <div className="flex justify-end gap-4 mt-8">
      <Button type="button" variant="outline" onClick={handleSubmit} className="px-8 py-3 text-white bg-black text-base">
